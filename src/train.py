...
def run_training():
    ...
    train_orig_targets,test_orig_targets
    ...
    train_loader = torch.utils.data.DataLoader(
        ...
        num_workers=config.IMAGE_WORKERS,
        shuffle = True)
    ...
    for epoch in tqdm(range(config.EPOCHS)):
        train_loss = engine.train_fn(model,train_loader,optimizer = optimizer)
        valid_loss, valid_preds = engine.eval_fn(model,test_loader)
        valid_cap_preds = []
